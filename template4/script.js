...
function generateCV(){
  ...
  document.getElementById("leetcodeT").innerHTML = document.getElementById("leField").value;

  document.getElementById("codechefT").innerHTML = document.getElementById("ccField").value;

  document.getElementById("codeforcesT").innerHTML = document.getElementById("cfField").value;

  document.getElementById("githubT").innerHTML = document.getElementById("gtField").value;
